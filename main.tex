...
\begin{titlepage}
	\begin{center}
		...
		\Huge
		\textbf{poop Determining the Crystaline Structure of Metals through X-Ray Diffraction}
		\large
		\vspace{1.5cm}
...
Figure \ref{} show this plot for the Copper and Nickel samples. From the plot, 
local maxima of light intensities can be located and indexed to find angles where diffraction in planes
occur. Tables \ref{} shows the angles and their peaks
