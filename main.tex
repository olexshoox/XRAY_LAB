...
Suppose the individual atoms of a crystal could be observed. While vayring the angle the observer 
makes with the plane of the solid, there will be an angle where the atoms appear to line
up. Given that a crystal is 3-dimension, the atoms will be aligned in parallel planes.
...
differentiated by their 'Miller index'. In Figure \ref{fig:plane111}, [!!!EXPLAIN 
HOW TO GET MILLER INDEX!!!]
Crystal are made of cells which can borrow one of fourteen 'Bravais lattices', each 
grounped into one of seven crystal systems. Figure \ref{fig:brav_lat} shows these lattices 
and their groups.
%
\begin{figure}[!bth]
...
\end{figure}
%
The Miller indices can be related to the inter-planar distance $d$, in equation 
\ref{eq:brag}, by various equations depending on the Bravais lattice. In a cubic crystal
...
for different cyrstal systems are given in Appendix \ref{}.
